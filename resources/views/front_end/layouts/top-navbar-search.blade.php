                          ...
                          <div class="scrollbar-overlay" style="max-height: 30rem;">
                              <div class="list pb-3">
                                  ...
                                  <div class="py-2"><a class="dropdown-item"
                                          href="{{ asset('front_end_links/phoenix/public/apps/e-commerce/landing/product-details.html') }}">
                                  ...
                                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                          ...
                                          <div class="file-thumbnail me-2"><img class="h-100 w-100 fit-cover rounded-3"
                                                  src="{{ asset('front_end_links/phoenix/public/assets/img/products/60x60/3.png') }}"
                                                  alt="" /></div>
                                          <div class="flex-1">
                                  ...
                                  <h6 class="dropdown-header text-1000 fs--1 border-bottom border-200 py-2 lh-sm">
                                      Members</h6>
                                  <div class="py-2"><a class="dropdown-item py-2 d-flex align-items-center"
                                          href="{{ asset('front_end_links/phoenix/public/pages/members.html') }}">
                                          <div class="avatar avatar-l status-online  me-2 text-900">
                                              <img class="rounded-circle "
                                                  src="{{ asset('front_end_links/phoenix/public/assets/img/team/40x40/10.webp') }}"
                                                  alt="" />
                                      ...
                                      <a class="dropdown-item py-2 d-flex align-items-center"
                                          ...
                                          <div class="avatar avatar-l  me-2 text-900">
                                              <img class="rounded-circle "
                                                  src="{{ asset('front_end_links/phoenix/public/assets/img/team/40x40/12.webp') }}"
                                                  alt="" />
