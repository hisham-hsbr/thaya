...
<body>
    ...
    <main style="--phoenix-scroll-margin-top: 1.2rem;">
                ...
                <div class="position-relative z-index-2">
                    <div class="row">
                        <div class="col-lg-6 text-center text-lg-start pe-xxl-3">
                            ...
                            <h2 class="mb-3 text-black lh-base">Seamless Payments: A Fully <br
                                    class="d-md-none" />Integrated Suite</h2>
                            <p class="mb-5">With the power of Phoenix, you can now focus only on functionaries for
                                your digital products, while leaving the UI design on us!With the power of Phoenix, you
                                can now focus only on functionaries for your digital products, while leaving the UI
                                design on us!</p><a class="btn btn-lg btn-outline-primary rounded-pill me-2"
                                href="#!" role="button">Find out more<i
                        ...
                        <div class="col-sm-6 col-lg-3 mt-7 text-center text-lg-start">
                            <div class="h-100 d-flex flex-column justify-content-between">
                                <div class="border-start-lg border-dashed ps-4"><img class="mb-4"
                                        src="{{ asset('front_end_links/phoenix/public/assets/img/icons/illustrations/bolt.png') }}"
                                    ...
                                    <div><a class="btn btn-link me-2 p-0 fs--1" href="#!" role="button">Check
                                            Demo<span class="fa-solid fa-angle-right ms-2"></span></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3 mt-7 text-center text-lg-start">
                            <div class="h-100 d-flex flex-column">
                                <div class="border-start-lg border-dashed ps-4"><img class="mb-4"
                                        src="{{ asset('front_end_links/phoenix/public/assets/img/icons/illustrations/pie.png') }}"
                                        width="48" height="48" alt="" />
                                    <div>
                                    ...
                                    <div><a class="btn btn-link me-2 p-0 fs--1" href="#!" role="button">Check
                                            Demo<i class="fa-solid fa-angle-right ms-2"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="col-lg-5"><img class="feature-image img-fluid mb-9 mb-lg-0 d-dark-none"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/22_2.png') }}"
                                alt="" /><img class="feature-image img-fluid mb-9 mb-lg-0 d-light-none"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/dark_22.png') }}"
                                alt="" /></div>
                        <div class="col-lg-6">
                    ...
                    <div
                        ...
                        <div class="col-lg-5 order-0 order-lg-1"><img
                                ...
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/23_2.png') }}"
                                height="394" alt="" /><img
                                class="feature-image img-fluid mb-9 mb-lg-0 d-light-none"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/dark_23.png') }}"
                                height="394" alt="" /></div>
                        <div class="col-lg-6">
                    ...
                    <div
                        class="row mt-2 align-items-center justify-content-between text-center text-lg-start mb-6 mb-lg-0">
                        <div class="col-lg-5"><img class="feature-image img-fluid mb-9 mb-lg-0 d-dark-none"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/24_2.png') }}"
                                height="394" alt="" /><img
                                class="feature-image img-fluid mb-9 mb-lg-0 d-light-none"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/dark_24.png') }}"
                                height="394" alt="" /></div>
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="mb-4 px-md-7 px-lg-0">With Phoenix, you can get ready reports on your growth
                                ...
                                needs.</p><a class="btn btn-link me-2 p-0 fs--1" href="#!" role="button">Check
        ...
        <div class="position-relative">
            <div class="bg-holder z-index-2 d-none d-md-block"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/13.png') }});background-size:auto;background-position:right;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder z-index-2 d-none d-md-block d-lg-none d-xl-block"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-12.png') }});background-size:auto;background-position:left;">
            </div>
            <!--/.bg-holder-->

            <div class="bottom-0 start-0 end-0 bg-white">
                <svg class="w-100 text-soft" viewBox="0 0 1920 368" fill="none"
                                        ...
                                        <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                                            <div class="col-lg-6 col-xl-5 text-center">
                                                <div
                                                    ...
                                                    <div class="bg-holder"
                                                        style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-2.png') }});background-size:contain;">
                                                    </div>
                                                    <!--/.bg-holder-->
                                                    <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                                                        src="{{ asset('front_end_links/phoenix/public/assets/img/team/61.webp') }}"
                                                        width="153" height="153" alt="" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                                            <div class="col-lg-6 col-xl-5 text-center">
                                                <div
                                                    ...
                                                    <!--/.bg-holder-->
                                                    <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                                                        src="{{ asset('front_end_links/phoenix/public/assets/img/team/8.webp') }}"
                                                        width="154" alt="" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xl-7 text-center text-lg-start">
                                        ...
                                        <div class="row g-1 g-lg-0 g-xl-1 pb-lg-3 pb-xl-0 ps-lg-1 ps-xl-0">
                                            <div class="col-lg-6 col-xl-5 text-center">
                                                <div
                                                    ...
                                                    <!--/.bg-holder-->
                                                    <img class="rounded-3 mb-lg-0 opacity-100 position-relative"
                                                        src="{{ asset('front_end_links/phoenix/public/assets/img/team/35.webp') }}"
                                                        width="154" alt="" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-xl-7 text-center text-lg-start">
        ...
        <div class="position-relative">
            <div class="bg-holder world-map-bg"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-13.png') }});">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder z-index-2 opacity-25"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-right-21.png') }});background-size:auto;background-position:right;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder z-index-2 mt-9 opacity-25"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-left-21.png') }});background-size:auto;background-position:left;">
            </div>
            <!--/.bg-holder-->
                    ...
                    <div class="position-relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 text-center text-md-start"><img class="img-fluid"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/generic/capterra.png') }}"
                                    alt="" /></div>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-white pb-lg-6 pb-xl-8">
            <div class="bg-holder d-dark-none"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-5.png') }});background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder d-light-none"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-dark-5.png') }});background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-left-5.png') }});background-position:left;background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-right-6.png') }});background-position:right;background-size:auto;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="container-small position-relative px-lg-7 px-xxl-3">
                ...
                <div class="row g-3" id="image_gallery" style="min-height: 948px"
                    ...
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
                            ...
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/1.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/1.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/2.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/2.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/3.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/3.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/5.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/5.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item third second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/4.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/4.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/6.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/6.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/7.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/7.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/9.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/9.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-3 px-2 isotope-item fourth"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/8.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/8.png') }}"
                                alt="" /></a>
                    </div>
                    <div class="col-6 col-md-4 col-lg-6 px-2 isotope-item second"><a href="#!"
                            data-bigpicture='{"gallery":"#image_gallery"}'
                            data-bp="{{ asset('front_end_links/phoenix/public/assets/img/gallery/10.png') }}"><img
                                class="rounded img-fluid w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/gallery/10.png') }}"
                                alt="" /></a>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-white pt-lg-0 pt-xl-8">
            <div class="bg-holder d-none d-md-block"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-left-15.png') }});background-position:left;background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder d-none d-md-block"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-right-15.png') }});background-position:right;background-size:auto;">
            </div>
            <!--/.bg-holder-->
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card h-100 rounded-start rounded-xl-start-0 mt-5 mt-md-0">
                            <div class="card-body px-6">
                                <div class="px-5">
                                    <div class="text-center pt-5"><img
                                            src="{{ asset('front_end_links/phoenix/public/assets/img/icons/illustrations/edit.png') }}"
                                            width="48" height="48" alt="" />
                            ...
                            <div class="col-xl-12">
                                <div class="card h-100 mt-5 mt-md-0">
                                    <div class="card-body">
                                        <div class="px-5">
                                            <div class="text-center pt-5"><img
                                                    src="{{ asset('front_end_links/phoenix/public/assets/img/icons/illustrations/shield.png') }}"
                                                    width="48" height="48" alt="" />
                ...
                <div class="row h-100 g-3 justify-content-center">
                    <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                        <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/blog/blog-1.png') }}"
                                alt="..." />
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                        <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/blog/blog-2.png') }}"
                                alt="..." />
                            <div class="card-body rounded-top">
                                <div class="d-flex align-items-cente mb-3">
                                    <div class="d-flex align-items-center me-3"><a
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                        <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/blog/blog-3.png') }}"
                                alt="..." />
                            <div class="card-body rounded-top">
                                <div class="d-flex align-items-cente mb-3">
                                    <div class="d-flex align-items-center me-3"><a
                    ...
                    <div class="col-sm-6 col-lg-3 mb-3 mb-md-0">
                        <div class="card text-white h-100"><img class="rounded-top h-100 fit-cover"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/blog/blog-4.png') }}"
                                alt="..." />
                            <div class="card-body rounded-top">
                                <div class="d-flex align-items-cente mb-3">
                                    <div class="d-flex align-items-center me-3"><a
                    ...
                    <div class="col-md-6 mb-5 mb-md-0 text-center text-md-start">
                        ...
                        <div class="d-flex flex-column align-items-center align-items-md-start gap-3 gap-md-0">
                            ...
                            <div class="mb-6 d-md-flex align-items-center">
                                ...
                                <div class="flex-1 ms-3"><a class="fw-semi-bold text-900" href="#!">39163 Amir
                                        Drive Suite 802</a></div>
                            </div>
                            <div class="d-flex"><a href="#!"><span
                                        class="fa-brands fa-facebook fs-2 text-primary me-3"></span></a><a
                                    href="#!"><span
                                        class="fa-brands fa-twitter fs-2 text-primary me-3"></span></a><a
                                    href="#!"><span
                                        class="fa-brands fa-linkedin-in fs-2 text-primary"></span></a></div>
                        </div>
                    </div>
        ...
        <section id="team">
            <div class="bg-holder z-index-2"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-left-17.png') }});background-size:auto;background-position:left center;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder z-index-2"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-right-17.png') }});background-size:auto;background-position:right center;">
            </div>
            <!--/.bg-holder-->
            ...
            <div class="position-absolute bottom-0 end-0 start-0">
                <svg class="text-white w-100" viewBox="0 0 1920 368" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 368L1920 0.730011L1920 368L0 368Z" fill="currentColor"></path>
                </svg>
            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                <div class="bg-holder"
                                    style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-21.png') }});background-size:contain;">
                                </div>
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/62.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>John Smith</h4>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/63.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Marc Chiasson</h4>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/64.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Lilah Lola</h4>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/65.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Thomas Doe</h4>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/66.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Alan Casey</h4>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/67.webp') }}"
                                    alt="..." />
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/68.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Narokin Hijita</h4>
                            <h6 class="mb-3 fw-semi-bold">CEO, Global Cheat</h6><a href="#!"><span
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="text-center mt-5 position-relative">
                            <div class="team-avatar-container d-inline-block position-relative">
                                ...
                                <!--/.bg-holder-->
                                <img class="img-fluid rounded mb-3 position-relative"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/team/69.webp') }}"
                                    alt="..." />
                            </div>
                            <h4>Narokin Hijita</h4>
                            <h6 class="mb-3 fw-semi-bold">CEO, Global Cheat</h6><a href="#!"><span
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="card py-md-9 px-md-13 border-0 z-index-1 shadow-lg cta-card">
                            <div class="bg-holder"
                                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-18.png') }});background-position:right;background-size:auto;">
                            </div>
                            <!--/.bg-holder-->

                            <div class="card-body position-relative"><img class="img-fluid mb-5 d-dark-none"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/27.png') }}"
                                    width="210" alt="..." /><img class="img-fluid mb-5 d-light-none"
                                    src="{{ asset('front_end_links/phoenix/public/assets/img/spot-illustrations/dark_27.png') }}"
                                    width="210" alt="..." />
                                <div class="d-flex align-items-center fw-bold justify-content-center mb-3">
                                    <p class="mb-0">2008 Premium Icons </p><span
                                        class="text-primary fa-solid fa-circle" data-fa-transform="shrink-12"></span>
        ...
        <div class="position-relative">
            <div class="bg-holder footer-bg"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-19.png') }});background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-right-20.png') }});background-position:right;background-size:auto;">
            </div>
            <!--/.bg-holder-->

            <div class="bg-holder"
                style="background-image:url({{ asset('front_end_links/phoenix/public/assets/img/bg/bg-left-20.png') }});background-position:left;background-size:auto;">
            </div>
            <!--/.bg-holder-->
                    ...
                    <div class="container-small px-lg-7 px-xxl-3">
                        <div class="row position-relative">
                            <div class="col-12 col-sm-12 col-lg-5 mb-4 order-0 order-sm-0"><a href="#"><img
                                        class="mb-3"
                                        src="{{ asset('front_end_links/phoenix/public/assets/img/icons/logo-white.png') }}"
                                        height="48" alt="" /></a>
                                <h3 class="text-white light">phoenix</h3>
                                <p class="text-white opacity-50 light">All over the world. Alice in <br />wonderland
                                    and other places.</p>
                            </div>
                            <div class="col-lg-7">
                    ...
                    <div class="card-header d-flex flex-between-center px-4 py-3 border-bottom">
                        ...
                        <div class="btn-reveal-trigger">
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-2"
                                aria-labelledby="support-chat-dropdown"><a class="dropdown-item"
                                    href="#!">Request a callback</a><a class="dropdown-item"
            ...
            <div class="setting-panel-item">
                ...
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionTopDouble">
                            <span class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none"
    ...
    <script src="{{ asset('front_end_links/phoenix/public/vendors/isotope-layout/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('front_end_links/phoenix/public/vendors/isotope-packery/packery-mode.pkgd.min.js') }}"></script>
    <script src="{{ asset('front_end_links/phoenix/public/vendors/bigpicture/BigPicture.js') }}"></script>
    <script src="{{ asset('front_end_links/phoenix/public/vendors/countup/countUp.umd.js') }}"></script>
