        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-auto order-0 order-md-1 text-end order-1">
                <div class="position-relative p-5 p-md-7 d-lg-none">
                    <div class="bg-holder"
                        style="background-image:url({{ asset('front_ent_links/phoenix/public/assets/img/bg/bg-23.png') }});background-size:contain;">
                        d </div>
                    <!--/.bg-holder-->

                    <div class="position-relative"><img class="w-100 shadow-lg d-dark-none rounded-2"
                            src="{{ asset('front_end_links/phoenix/public/assets/img/bg/bg-31.png') }}"
                            alt="hero-header" /><img class="w-100 shadow-lg d-light-none rounded-2"
                            src="{{ asset('front_end_links/phoenix/public/assets/img/bg/bg-30.png') }}"
                            alt="hero-header" /></div>
                </div>
                    ...
                    <div class="position-relative h-100 w-100">
                        <div
                            ...
                            <img class="pt-7 pt-md-0 w-100"
                                src="{{ asset('front_end_links/phoenix/public/assets/img/bg/bg-1-2.png') }}"
                                alt="hero-header" />
                        </div>
                        <div class="position-absolute h-100 top-0 d-flex align-items-center end-0"><img
                                ...
                                src="{{ asset('front_end_links/phoenix/public/assets/img/bg/bg-28.png') }}"
