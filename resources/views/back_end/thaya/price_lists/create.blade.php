        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Price List Create')
                    <form role="form" action="{{ route('price-lists.store') }}" method="post" enctype="multipart/form-data"
                        id="quickForm">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <!-- /.card-header -->
                            <div class="row">
                                ...
                                <x-form.form-group-label-input div_class="col-sm-4" label_for="code" lable_class="required"
                                    ...
                                    input_style="text-transform: uppercase" input_id="code" input_value="{{ old('code') }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-4" label_for="name" lable_class="required"
                                    ...
                                    input_style="text-transform: uppercase" input_id="name" input_value="{{ old('name') }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-4" label_for="group" lable_class="required"
                                    ...
                                    input_style="text-transform: uppercase" input_id="group" input_value="{{ old('group') }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-4" label_for="uom" lable_class="required"
                                    ...
                                    input_style="text-transform: uppercase" input_id="uom" input_value="{{ old('uom') }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-2" label_for="packet_price"
                                    ...
                                    input_value="{{ old('packet_price') }}" input_placeholder="0.00" />
                                ...
                                <x-form.form-group-label-input div_class="col-sm-2" label_for="half_packet_price"
                                    ...
                                    input_id="half_packet_price" input_value="{{ old('half_packet_price') }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-2" label_for="wholesale_price"
                                    ...
                                    input_id="wholesale_price" input_value="{{ old('wholesale_price') }}"
                                    input_placeholder="0.00" />
                                ...
                                <x-form.form-group-label-input div_class="col-sm-2" label_for="cash_price"
                                    ...
                                    input_id="cash_price" input_value="{{ old('cash_price') }}" input_placeholder="0.00" />
                                ...
                                <x-form.form-group-label-input div_class="col-sm-2" label_for="credit_price"
                                    ...
                                    input_id="credit_price" input_value="{{ old('credit_price') }}"
                                    input_placeholder="0.00" />
